#!/bin/bash
#SBATCH --job-name=samtools_simplex
...
singularity exec -B /projects /projects/health_sciences/bms/biochemistry/dearden_lab/Taylor/Containers/samtools_v1.21-noble.sif \
	samtools view /projects/health_sciences/bms/biochemistry/dearden_lab/Taylor/Velvetworm_Bragato_Dec42024/Dorado_Out/velvetworm_duplex.bam | grep -c "dx:i:[0|-1]"
